                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form action="<?= base_url('datamd/save_datamd') ?> " method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="date" name="tgl_mendu" class="form-control" placeholder="Tanggal">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="sebab" class="form-control" placeholder="Penyebab">
                                        </div>
                                    </div>
