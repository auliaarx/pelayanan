                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <?= validation_errors() ?>
                            <form action="<?= base_url('datapendatang/save_datapendatang') ?> " method="POST">
                                <div class="card-body">

                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">NIK</label>
                                        <div class="col-sm-6">
                                            <input type="text" name="nik_datang" class="form-control" placeholder="NIK">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="nama_datang" class="form-control" placeholder="Nama pendatang">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="date" name="tgl_datang" class="form-control" placeholder="Tanggal lahir">
                                        </div>
                                    </div>
